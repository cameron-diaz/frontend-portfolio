...
export default function Project({
    ...
    return (
        <motion.div
            ...
            className='group mb-[20rem] last:mb-0 sm:mb-8'
        >
            <section className='relative max-w-[42rem] overflow-hidden rounded-lg border-black/5 bg-gray-100 transition hover:bg-gray-200 group-even:pl-8 sm:h-[20rem] sm:pr-8 dark:bg-white/10 dark:hover:bg-white/20'>
                <div className='flex h-full flex-col px-5 pb-6 pt-4 sm:max-w-[50%] sm:pl-10 sm:pr-2 sm:pt-10 sm:group-even:ml-[18rem] dark:text-white'>
