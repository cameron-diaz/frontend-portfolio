...
export default function Project({
  ...
  return (
    ...
    >
      <section className='relative max-w-[42rem] overflow-hidden rounded-lg border-black/5 bg-gray-100 transition hover:bg-gray-200 group-even:pl-8 sm:h-[20rem] sm:pr-8 '>
